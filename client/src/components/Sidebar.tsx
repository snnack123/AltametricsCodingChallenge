...
export default function Sidebar(props: { readonly children: JSX.Element }) {
  ...
  const handleSidebarLinkClick = useCallback((item: NavigationItem):void => {
  ...
  return (
    <div className="flex">
      <div className="flex grow flex-col gap-y-5 overflow-y-auto border-r border-gray-200 bg-secondary px-6 w-[14.5rem] h-screen">
                              ...
                              {item?.children?.map((subItem) => (
                                <li key={subItem.name}>
                                  <Disclosure.Button
                                    as="a"
                                    href={subItem.href}
                                    onClick={() => handleSidebarLinkClick(subItem)}
                                    className={classNames(
                                      subItem.current
                                        ? "activeLink"
                                        : "inactiveLink",
